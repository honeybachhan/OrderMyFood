		...
		while($row=$stmt->fetch(PDO::FETCH_ASSOC))
		{
			...
			?>
				...
				<div class="vendor__details">
					<div class="vendor__title" class="icon icon-deals">
					
						<?php echo $item_name;?>
						<span class="menu-item__dish-characteristics"  > 
						<?php
						if($type=="nonveg")
						{
					...
					<div class="vendor__details__footer" >
						...
						<input type='text' style="width: 56px;" name="<?php echo 'qty'.$i; ?>" id="<?php echo 'qty'.$i; ?>"  value="0"  readonly=true/>
