...
if(isset($_POST['sub']))
{
	...
	$toemailaddress=$email;
        ...
        $body ='<html><body><p>To Reset Your Password </p><a href="http://localhost/OrderMyFood/owner_resetpassword.php?email='.$email.'">Click Here</a></body></html>';
                        ...
                        <div class="text-center">
                          ...
                          <p>You can reset your password here.</p>
                            <div class="panel-body">
                              ...
                              <form class="form" action="owner_forgotpassword.php" method="post">
                                <fieldset>
