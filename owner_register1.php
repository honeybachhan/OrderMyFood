...
require 'connecttomysql.php';
 ...
 if(isset($_POST['regi']))
{
	$query1= "select * from owner_detail where mob = '$_POST[mob]'";
...
'$_POST[cpass]','$mob','$email','$_POST[hname]','$hid','$_POST[address]','$_POST[city]','$_POST[state]','$_POST[pincode]','$_POST[country]','$_POST[website]'
	                            ...
	                            <div class="form-bottom">
				                    <form role="form" action="" method="post" class="registration-form" name="Registration"onsubmit="return(validate());" enctype="multipart/form-data" >
										...
										<div class="form-group">
				                        	...
				                        	<input type="hidden" name="hid" class="form-last-name form-control" value="" id="hid">
				                        </div>
										<div class="form-group">
