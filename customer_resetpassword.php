...
if(  $pass==$cpass)
{
	mysqli_query($connect,"UPDATE customer_detail SET pass='$pass',cpass='$cpass' where email='$email'");
	echo ("<SCRIPT LANGUAGE='JavaScript'>
    window.alert('Password Changed Successfully');
    </SCRIPT>");
	echo "<meta http-equiv='refresh' content='2;url=customer_login.php'>";
}
else
{
	echo ("<SCRIPT LANGUAGE='JavaScript'>
    window.alert('Password annot Be Changed');
    </SCRIPT>");
}	
}
?>
                        ...
                        <div class="text-center">
                          ...
                          <p>You can reset your password here.</p>
                            <div class="panel-body">
                              ...
                              <form class="form" action="customer_resetpassword.php" method="post">
